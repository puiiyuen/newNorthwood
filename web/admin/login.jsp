...
<%
    ...
    if (logUser == null && (email == null || password == null)&&userType!="admin") {
%>
    ...
    <section class="row justify-content-center">
        ...
        <section class="col-12 col-sm-6 col-md-3">
            ...
            <form class="form-container" action="login.jsp" method="post">
                ...
                <h4 class="text-center font-weight-bold text-color">Administrator</h4>
...
<%
    ...
    if (session.getAttribute("ForwardURL") != null) {
        String fdURL = (String) session.getAttribute("ForwardURL");
        session.setAttribute("ForwardURL", null);
        response.sendRedirect(fdURL);
    } else
