...
<%
    ...
    boolean checkNull = username == "" || email == "" || passwd1 == "" || passwd2 == ""
            || username == null || email == null || passwd1 == null || passwd2 == null;
        ...
        <section class="col-12 col-sm-6 col-md-3">
            ...
            <form class="form-container" action="register.jsp" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="inputName" name="inputName" aria-describedby="emailHelp"
