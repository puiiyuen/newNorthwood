...
public class testDriver {
    ...
    static void testFeedback(fetchMenu fm,submitFeedback sb) {


        System.out.println("---Test Feedback System---");
        try{
            fm.menu("Monday");
            String[] id={1,2,3};
            int[] vote={1,1,1};
            sb.submit("test@smu.ca","I love butter chicken",vote,id);

        }catch (Exception e){
            System.out.println("---Feedback Failed---");
        }
        System.out.println("---Feedback Test Finished---");
